...
function renderCards() {
    ...
    pokerPlayers.forEach(({ player, index }) => {
        ...
        switch (numPlayers) {
            ...
            case 3:
                if (index === 0) {
                    playerDiv.className += ' top'; // Position the first opponent at the top
                } else if (index === 1) {
                    playerDiv.className += ' middle-left'; // Position the second opponent at the middle-left
                } else if (index === 2) {
                    playerDiv.className += ' middle-right'; // Position the third opponent at the middle-right
                }
                playersDiv.appendChild(playerDiv);
                break;
            case 4:
                if (index === 0) {
                    ...
                    playerDiv.className += ' bottom'; // Position the fourth opponent at the bottom
                }
                playersDiv.appendChild(playerDiv);
                break;
        }
