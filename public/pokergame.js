...
function renderCards() {
    ...
    pokerPlayers.forEach(({ player, index }) => {
        ...
        switch (numPlayers) {
            ...
            case 3:
                if(myIndex == 0) {
                    if (index === 0) {
                        playerDiv.classList.add('top'); // Position the first opponent at the top
                    } else if (index === 1) {
                        playerDiv.classList.add('middle-left');
                        containerDiv.appendChild(middleDiv); // Position the second opponent at the middle-left
                    } else if (index === 2) {
                        playerDiv.classList.add('middle-right'); // Position the third opponent at the middle-right
                    }
                }
                if(myIndex == 1) {
                    if (index === 0) {
                        playerDiv.classList.add('top');
                        containerDiv.appendChild(middleDiv); // Position the first opponent at the top
                    } else if (index === 1) {
                        playerDiv.classList.add('middle-left');
                         // Position the second opponent at the middle-left
                    } else if (index === 2) {
                        playerDiv.classList.add('middle-right'); // Position the third opponent at the middle-right
                    }
                }
            ...
            case 4:
                ...
                if (index === 0) {
                    ...
                    playerDiv.classList.add('middle-left');
                    containerDiv.appendChild(playerDiv); // Position the second opponent at the middle-left
                    ...
                    middleDiv.appendChild(playerDiv); // Position the fourth opponent between middle-left and middle-right
                ...
                if(myIndex == 1) {
                    if (index === 0) {
                        playerDiv.classList.add('top');
                        containerDiv.appendChild(playerDiv); // Position the first opponent at the top
                    } else if (index === 1) {
                        playerDiv.classList.add('middle-left');
                        //containerDiv.appendChild(playerDiv); // Position the second opponent at the middle-left
    ...
    if (clientHand) {
        ...
        containerDiv.appendChild(clientDiv); // Append client at the bottom
    } else {
        console.error(`No hand found for the client (Player ${myIndex + 1})`);
    }

    playersDiv.appendChild(containerDiv); // Append the container to the playersDiv
