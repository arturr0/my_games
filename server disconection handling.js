...
pokerNamespace.on('connection', (socket) => {
    ...
    socket.on('joinServer', (data) => {
        ...
        fs.readFile(jsonFilePath2, 'utf8', (err, fileData) => {
            ...
            function find4players(pokerUsers, playersNumber) {
                ...
                pokerUsers.forEach((user, i) => {
                    if (!indexGroups[user.index] && user.full != 1) {
            ...
            const four_players = find4players(pokerUsers, 4);
                ...
                if (!userExistsInAnyRoom(socket.id)) {
                    ...
                    if (!userExistsInRoom(roomObj, socket.id)) {
                        ...
                        if (roomObj.users.length === 2) {
                            ...
                            for(let i = 0; pokerUsers.length; i++)
                    ...
                    try {
                        ...
                        if (jsonData[socket.serverIndex]) {
                            ...
                            for (let i = 0; i < pokerUsers.length; i++) {
                                if (socket.id === pokerUsers[i].id && jsonData[pokerUsers[i].index].user1 === pokerUsers[i].user) {
                                    jsonData[pokerUsers[i].index].user1 = '';
                                    //jsonData[pokerUsers[i].index].players--;
                                } else if (socket.id === pokerUsers[i].id && jsonData[pokerUsers[i].index].user2 === pokerUsers[i].user) {
                                    jsonData[pokerUsers[i].index].user2 = '';
                                    //jsonData[pokerUsers[i].index].players--;
                                }
                                else if (socket.id === pokerUsers[i].id && jsonData[pokerUsers[i].index].user3 === pokerUsers[i].user) {
                                    jsonData[pokerUsers[i].index].user3 = '';
                                    //jsonData[pokerUsers[i].index].players--;
                                }
                                else if (socket.id === pokerUsers[i].id && jsonData[pokerUsers[i].index].user4 === pokerUsers[i].user) {
                                    jsonData[pokerUsers[i].index].user4 = '';
                                    //jsonData[pokerUsers[i].index].players--;
                                }
                                else if (socket.id === pokerUsers[i].id && jsonData[pokerUsers[i].index].user2 === pokerUsers[i].user) {
                                    jsonData[pokerUsers[i].index].user2 = '';
                                ...
                                if (socket.id === pokerUsers[i].id && jsonData[socket.serverIndex].players == 0)
                                    jsonData[pokerUsers[i].index].block = 1;
                            ...
                            fs.writeFile(jsonFilePath2, JSON.stringify(jsonData, null, 2), (writeErr) => {
                                if (writeErr) {
                                    ...
                                    console.log('JSON poker file updated successfully after disconnection');
                                }
